...
<div class="onda-s"> <!--Onda-s-->
    <div class="container text-center">
        ...
        <div class="row"><!--slider movil-->
            <div class="col-md-3">
                <img src="{{asset('img/icon/planta2.svg')}}"  width="180" alt="Equipamiento del desarrollo | Gran Calzada">
...
<div class="que-encontraras text-center pt-5">
    ...
    <div class="row pt-4"><!--slider movil-->
        <div class="col">
            <img src="{{asset('img/gran-calzada/carateristicas/1.svg')}}"  width="180" alt="Equipamiento del desarrollo | Gran Calzada">
            <h3 class="equipamiento-g sp ">Escuelas</h3>
        </div>
        <div class="col">
            <img src="{{asset('img/gran-calzada/carateristicas/2.svg')}}"  width="180" alt="Equipamiento del desarrollo | Gran Calzada">
            <h3 class="equipamiento-g sp-1">Comercios</h3>
        </div>
        <div class="col">
            <img src="{{asset('img/gran-calzada/carateristicas/3.svg')}}"  width="180" alt="Equipamiento del desarrollo | Gran Calzada">
            <h3 class="equipamiento-g pt-2">Áreas verdes</h3>
        </div>
        <div class="col">
            <img src="{{asset('img/gran-calzada/carateristicas/4.svg')}}"  width="180" alt="Equipamiento del desarrollo | Gran Calzada">
            <h3 class="equipamiento-g pt-2">Parques <br>interactivos</h3>
        </div>
        <div class="col">
            <img src="{{asset('img/gran-calzada/carateristicas/5.svg')}}"  width="180" alt="Equipamiento del desarrollo | Gran Calzada">
...
<section id="desarrollos-gc">
    <div class="container">
        <h2 class="text-center pt-2 titular-modelos" style="color: #1A2C4C"><span class="conoce  pb-2">CONOCE</span><br>nuestros <span class="dos">2</span> desarrollos: <br>
    ...
    <div class="container marco">
        <div class="aire">
            <div class="row">
                ...
                <p>Grupo Casitas Desarrollos, empresa con más de 15 años de experiencia diseñando, planeando. construyendo y comercializando comunidades, en busca siempre de la innovación y sustentabilidad para otorgar a los habitantes de sus desarrollos beneficios excluisvos de calidad, ubicación y diseño.</p>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    <h1 class="casitas-h">20 <br> <span class="casitas-p">DESARROLLOS<br> CONSTRUIDOS</span></h1>
                </div>
                <div class="col-md-4">
                    <h1 class="casitas-h">20 <br> <span class="casitas-p">HABITANTES <br> EN NUESTROS<br> DESARROLLOS</span></h1>
                </div>
                <div class="col-md-4">
