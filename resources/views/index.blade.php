        ...
        <div class="row">
           <div class="col-12">
                <div class="video mt-2">
                    <video src="{{asset('/video/1000x500.mp4') }}" controls  preload width="1000" height="auto" autoplay></video>
                </div>
           </div>
           <div class="col-12">
    ...
    <div class="container-fluid">
        <div class="row over">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 txt-calzada">
                <h2 style="text-align: left" class="mb-4">Descubre cómo es vivir en una ciudad totalmente planeada</h2>
   ...
   <section id="desarrollos">
       <div class="container">
        <div class="beneficios">
           ...
           <h2 class="text-center pt-5 titular-modelos" style="color: #1A2C4C"><span class="conoce  pb-2">CONOCE</span><br>nuestros <span class="dos">2</span> desarrollos: <br>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="{{asset('/img/avances-de-obra/GCAL-Avances-deObra2.jpg')}}" class="d-block w-100" alt="avances de obra - Gran Calzada">
                      </div>
                      <div class="carousel-item">
                        <img src="{{asset('/img/avances-de-obra/GCAL-Avances-deObra3.jpg')}}" class="d-block w-100" alt="avances de obra - Gran Calzada">
                      </div>
                      <div class="carousel-item">
                        <img src="{{asset('/img/avances-de-obra/GCAL-Avances-deObra4.jpg')}}" class="d-block w-100" alt="avances de obra - Gran Calzada">
                      </div>
                    </div>
