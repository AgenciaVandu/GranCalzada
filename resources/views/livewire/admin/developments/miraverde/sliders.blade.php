<div>
            ...
            <div x-show="open">
                <form wire:submit.prevent="uploadHeaderSlider">
                        ...
                        @isset($header->resources)
                            ...
                            <div x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <label
                                    ...
                                    <input type='file' wire:model="files_1" class="hidden" multiple
                                        {{-- accept="image/*,video/*" --}}>
                                </label>
                                <!-- Progress Bar -->
                    ...
                    <div class="flex justify-end items-center py-2 px-3">
                        ...
                        @error('files_1.*') <span class="text-sm text-red-600 mr-2">{{ $message }}</span> @enderror
    ...
    <div class="px-6 mt-6"x-data="{open:false}">
        <div class="bg-gray-50 shadow-lg mb-4">
            ...
            <div x-show="open">
                <form wire:submit.prevent="uploadBodySlider">
                    <div class="flex flex-wrap p-4">
                        @isset($body->resources)
                            ...
                            <div x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <label
                                    ...
                                    <i class="far fa-plus-square text-5xl"></i>
                                    <span class="mt-4">Seleccionar archivo(s)</span>
                                    <input type='file' wire:model="files_2" class="hidden" multiple
                                        {{-- accept="image/*,video/*" --}}>
                                </label>
                                <!-- Progress Bar -->
                                <div class="text-center py-6 text-white font-bold" x-show="isUploading">
                    ...
                    <div class="flex justify-end items-center py-2 px-3">
                        @error('files_2.*') <span class="text-sm text-red-600 mr-2">{{ $message }}</span> @enderror
