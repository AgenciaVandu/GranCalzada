    ...
    <div class="px-6 mt-6" x-data="{open:false}">
        <div class="bg-gray-50 shadow-lg mb-4">
            <div class="py-1 px-2 bg-gray-200 rounded rounded-t-lg mb-2 cursor-pointer hover:bg-gray-100"
                ...
                <h2 class="text-xl text-gray-800 font-bold">Video Cuerpo</h2>
            </div>
            <div x-show="open">
                <form wire:submit.prevent="uploadBodyVideo">
                            ...
                            @foreach ($video->resources as $resource)
                                <div class="shadow-md bg-white rounded-lg mx-2 mt-4">
                                    ...
                                    <div class="flex justify-between items-center py-2 mx-2">
                                        ...
                                        <label>
                                            Visible:
                                            <input type="checkbox" class="mr-2" wire:model="visible" wire:click="setVisible">
                                        </label>
                                    </div>
                                </div>
                            @endforeach
