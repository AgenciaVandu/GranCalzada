<div>
    {{-- Boton slider header Gran Calzada --}}
    <div class="px-6 mt-6" x-data="{open:true}">
        <div class="bg-gray-50 shadow-lg mb-4">
            <div class="py-1 px-2 bg-gray-200 rounded rounded-t-lg mb-2 cursor-pointer hover:bg-gray-100"
                ...
                <h2 class="text-xl text-gray-800 font-bold">Boton slider Gran Calzada</h2>
            </div>
            <div x-show="open">
    ...
    {{-- Slider header Gran Calzada --}}
    <div class="px-6 mt-6" x-data="{open:true}">
        <div class="bg-gray-50 shadow-lg mb-4">
            <div class="py-1 px-2 bg-gray-200 rounded rounded-t-lg mb-2 cursor-pointer hover:bg-gray-100"
                x-on:click="open=!open">
                <h2 class="text-xl text-gray-800 font-bold">Slider Gran Calzada</h2>
            </div>
            <div x-show="open">
                <form wire:submit.prevent="uploadGranCalzadaSlider()">
                    <div class="flex flex-wrap p-4">
                        @isset($slider2->resources)
                            @foreach ($slider2->resources as $resource)
                        ...
                        <div x-data="{ isUploading: false, progress: 0 }"
                            ...
                            <label
                                ...
                                <input type='file' wire:model="files2" class="hidden" multiple
                                    {{-- accept="image/*,video/*" --}}>
                            </label>
                            <!-- Progress Bar -->
                    ...
                    <div class="flex justify-end items-center py-2 px-3">
                        @error('files2*') <span class="text-sm text-red-600 mr-2">{{ $message }}</span>
                        @enderror
                        <x-jet-button class="bg-gray-800 text-white px-2 py-1" type="submit"
                            wire:loading.attr="disabled">
                            Guardar
