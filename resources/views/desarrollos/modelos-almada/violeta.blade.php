            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <ul>
                            <li class="modelo-li ">Modelo Violeta</li>
                            <br>
                        ...
                        <div class="row m-botones botones-modelos">
                            <div class="col-md-6 col-sm-12 mt-3">
                                <a href="/lead-violeta" class="btn btn-secondary ">Cotizar modelo</a>
                            </div>
                            <div class="col-md-6 col-sm-12 mt-3">
                    ...
                    <div class="col-md-6 col-sm-12 text-center">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <img src="{{ asset('/img/almada/modelos/violeta/planta_baja.png') }}" class="img-fluid"
                                    alt="">
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <img src="{{ asset('/img/almada/modelos/violeta/planta_alta.png') }}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
