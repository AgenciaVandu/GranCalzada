                    ...
                    <div class="carousel-inner">
                        ...
                        @else
                            <div class="carousel-item active">
                                <img src="{{ asset('/img/almada/modelos/violeta-plus/violeta-plus.jpg') }}"
...
<!-- Modal 3-->
<div class="modal fade" id="modal-ficha-vplus" tabindex="-1" aria-labelledby="exampleModalLabel"
aria-hidden="true">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-center">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <img src="{{ asset('/img/almada/modelos/violeta-plus/planta_baja.png') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <img src="{{ asset('/img/almada/modelos/violeta-plus/planta_alta.png') }}"
                                    class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    @switch($model->id)
                                                        @case(1)
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6 der-mod pt-3">
                                                                    <p>1 baño</p>
                                                                    <div class="espacio-bco-violeta-2">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        @case(3)
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6 der-mod pt-3">
                                                                    <p>1 baño</p>
                                                                    <div class="espacio-bco-violeta-3">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        @break
