                    ...
                    <div class="carousel-inner">
                        ...
                        @else
                            <div class="carousel-item active">
                                <img src="{{ asset('/img/miraverde/modelos/almendro/almendro.jpg') }}" class="d-block w-100"
                                    alt="...">
                            </div>
                        @endisset
                    </div>
            ...
            <div class="modal-body" style="background-color: #c9dbfa">
                ...
                <script>
                    hbspt.forms.create({
                        region: "na1",
                        portalId: "5510950",
                        formId: "dafaf23c-f78f-455a-9c2e-d0606eb3dab6"
                    });
                </script>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-center">
                        <img src="{{ asset('/img/miraverde/modelos/almendro/planta_baja.png') }}" class="img-fluid"
                            alt="">
                    </div>
                </div>
