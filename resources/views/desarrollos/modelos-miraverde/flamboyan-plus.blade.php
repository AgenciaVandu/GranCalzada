                    ...
                    <div class="carousel-inner">
                        ...
                        @else
                            <div class="carousel-item active">
                                <img src="{{ asset('/img/miraverde/modelos/flamboyan-plus/flamboyan-plus.jpg') }}"
         ...
         <div class="modal-body" style="background-color: #c9dbfa">
             ...
             <script>
                 hbspt.forms.create({
                     region: "na1",
                     portalId: "5510950",
                     formId: "98c6bd78-0ed6-4b2e-866a-2e410c204a69"
                 });
             </script>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-center">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <img src="{{ asset('/img/miraverde/modelos/flamboyan-plus/planta_baja.png') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <img src="{{ asset('/img/miraverde/modelos/flamboyan-plus/planta_alta.png') }}"
                                    class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="carousel_1">
                            ...
                            <div class="carousel__contenedor">
                                ...
                                <div class="carousel__lista2">
                                    @foreach ($miraverde->models->except($model->id) as $model)
