                    ...
                    <div class="carousel-inner">
                        ...
                        @else
                            <div class="carousel-item active">
                                <img src="{{ asset('/img/miraverde/modelos/bugambilia-plus/bugambilia-plus.jpg') }}"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-center">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <img src="{{ asset('/img/miraverde/modelos/bugambilia-plus/planta_baja.png') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <img src="{{ asset('/img/miraverde/modelos/bugambilia-plus/planta_alta.png') }}"
                                    class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
