                    ...
                    <div class="carousel-inner">
                        ...
                        @else
                            <div class="carousel-item active">
                                <img src="{{ asset('/img/miraverde/modelos/ceiba-plus/ceiba-plus.jpg') }}"
         ...
         <div class="modal-body" style="background-color: #c9dbfa">
             ...
             <script>
                 hbspt.forms.create({
                     region: "na1",
                     portalId: "5510950",
                     formId: "6ddd5e3d-8ad6-4d5d-aedf-efa190a73d64"
                 });
             </script>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-center">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <img src="{{ asset('/img/miraverde/modelos/ceiba-plus/planta_baja.png') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <img src="{{ asset('/img/miraverde/modelos/ceiba-plus/planta_alta.png') }}"
                                    class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
