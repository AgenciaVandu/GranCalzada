                            ...
                            <div class="row pt-4">
                                <div class="col-md-6 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6 icon-amenidades-mv">
                                            <img src="{{ asset('/img/miraverde/amenidades/gimnasio-03.svg') }}" width="43"
                                                alt="">
                                        </div>
                                        <div class="col-6">
                    ...
                    <div class="card bg-cruzada ">
                        ...
                        <div class="row" > <!--Amenidades por modelo-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 izq-mv">
                                    <img src="{{ asset('/img/miraverde/venta-cruzada/icon/comedor.svg') }}" width="36"
                                        alt="">
                                </div>
                                <div class="col-6 der-mv pt-2">
                                    <p>Sala / Comedor </p>
                                ...
                                <div class="col-6 izq-mv ">
                                    <img src="{{ asset('/img/miraverde/venta-cruzada/icon/cocina.svg') }}" width="32"
                                        alt="">
                                </div>
                                <div class="col-6 der-mv">
                                    <p>Cocina <br> independiente</p>
                                ...
                                <div class="col-6 izq-mv">
                                    <img src="{{ asset('/img/miraverde/venta-cruzada/icon/recamara.svg') }}" width="32"
                                        alt="">
                                </div>
                                <div class="col-6 der-mv pt-1">
                                    <p>2 Recámaras</p>
                        ...
                        <div class="card bg-cruzada">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 izq-mv pt-2">
                                    <img src="{{ asset('/img/miraverde/venta-cruzada/icon/terraza.svg') }}" width="40"
                                        alt="">
                                </div>
                                <div class="col-6 der-mv pt-3">
                                    <p>Terraza</p>
